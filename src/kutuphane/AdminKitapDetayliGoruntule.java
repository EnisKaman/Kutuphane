...
public class AdminKitapDetayliGoruntule extends javax.swing.JFrame {
    ...
    public AdminKitapDetayliGoruntule() {
        initComponents();
    }

    public AdminKitapDetayliGoruntule(int kitapkodu, String kitapadi, String yazaradi, String yayinevi, String kitapturu, String kitapozeti,  byte[] imagedata, int toplamkitapsayisi, int eldeolankitapsayisi) {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlResim.add(lblResim, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 440));
        ...
        pnlKitapEklemeLayout.setHorizontalGroup(
            ...
            .addGroup(pnlKitapEklemeLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(pnlResim, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminKitapDetayliGoruntule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminKitapDetayliGoruntule().setVisible(true);
            }
        });
    }
